...
public class Scene_7_ruLesson extends BaseScene {
    ...
    private void printHistory(){
        printLn("Ученик приходит на урок русского языка");
        printLn("Сегодня проходим чередование гласных в суффиксе");
        printLn("Учитель спрашивает вас какое чередование реально существует?");
